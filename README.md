...
## Github
If you're not familiar with github, the basic idea is that you *fork* the server to make your own copy of it on github,
then create a *pull request* here to have me merge your changes into the main branch.
It is suggested you get [GitHub Desktop](https://desktop.github.com/) to work on your fork.

## Setup
1. Clone your fork of the server to your computer. You should then have a new folder for the repo, which we'll call the *server folder*.
...
You can see your new admin commands using `/help` (in the console, not chat).